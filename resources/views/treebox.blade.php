...
<html>
    ...
    <body style="overflow: hidden;" oncontextmenu="return false;">
        <div class="container-fluid">
                        ...
                        <div style='display: flex'>
                            <select class="form-control" id="mone_av" name="mone_av">
                                ...
                                <option value="<?= $each->mone ?>" @if ($mone_av == $each->mone) selected @endif>
                                    <?= $each->mone .'(' . $each->address .')' ?>
                                </option>
                                @endforeach
                            </select>
                            <button style="align-self: center;margin-left: 20px;" type="submit" class="btn btn-primary">Display</button>
                        </div>
                    </fieldset>
            ...
            @else
                <h2><center>Select Mone and Press Display to view Water System</center></h2>
            @endisset
        </div>
